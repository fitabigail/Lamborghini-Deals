...
class UpdateInquiery(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'email': forms.EmailInput(attrs={'class': 'form-control', 'placeholder':'Email :ex. example@info.com'}),
            'comment': forms.Textarea(attrs={'class': 'form-control', 'placeholder':'Write message'}),
