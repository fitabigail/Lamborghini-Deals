        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.company-logo img').attr('src', 'https://res.cloudinary.com/dlpvlra1t/image/upload/v1675442516/media%20lamborghini/black-logo_b20eto_qqzshy.png');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1 && $('.fixed-header').length == 0 && $('.fixed-header2').length == 0) {
                    $('.company-logo img').attr('src', 'https://res.cloudinary.com/dlpvlra1t/image/upload/v1675441884/media%20lamborghini/logo_ogjual_egon44.png');
                } else {
                    $('.company-logo img').attr('src', 'https://res.cloudinary.com/dlpvlra1t/image/upload/v1675442516/media%20lamborghini/black-logo_b20eto_qqzshy.png');
                }
            }
